...
<title>Monochrome Event Team</title>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="top_left_cont intro zoomIn wow animated"> 
              <h2>I’m Galang<br> <strong>CEO of Monochrome</strong></h2>
              <p>
			  I am from Aceh with a passion of Android, Graphic and Interactive design. 
			  I specialise in standards compliant Android applications with a focus on usability.
              Enthusiastic about life, design and innovation. </p>
                <div class="underline"></div>             
              <ul class="social_links">
				<li class="twitter animated bounceIn wow delay-02s animated" style="visibility: visible; animation-name: bounceIn;"><a href="https://wa.link/n2uxnx"><i class="fa fa-comments"></i></a></li>
				<li class="instagram animated bounceIn wow delay-03s animated" style="visibility: visible; animation-name: bounceIn;"><a href="https://www.instagram.com/galangpratamaaaa/"><i class="fa fa-instagram"></i></a></li>
				<li class="pinterest animated bounceIn wow delay-04s animated" style="visibility: visible; animation-name: bounceIn;"><a href="https://www.youtube.com/channel/UC1va19-zmtI48zn0Wcx1FcQ"><i class="fa fa-youtube"></i></a></li>
				<li class="gplus animated bounceIn wow delay-05s animated" style="visibility: visible; animation-name: bounceIn;"><a href="https://github.com/rapYOURex"><i class="fa fa-github"></i></a></li> 
			  </ul> 
			  </div>
          </div> 
		  <div class="col-md-6">
		   <img alt="" src="img/profile-picx.jpg">
		  </div>
        </div>
      </div>
    </div>
...
<div class="inner_wrapper aboutUs-container fadeInLeft animated wow">
  <div class="container">
    <h2>About Me</h2>
	<h6>Yuk kenalan dulu biar makin sayang</h6>
    <div class="inner_section"> 
	  <div class="row">
						<div class="col-lg-12 about-us">
							<div class="row">
								<div class="col-md-6">
									<h3>I am hard worker with passion</h3>
									<p>
										Bismillahirrahmanirrahim, sebelumnya izinkan saya untuk memperkenalkan diri terlebih dahulu. Nama saya Galang Pandu Pratama, pemuda berusia 20 Tahun berasal dari Banda Aceh, agama saya islam, dan berkewarnageraan Indonesia. Saya adalah seorang mahasiswa dari Kampus Politeknik Aceh Program Studi Teknologi Informasi.
									</p>
									<p>
										Riwayat Pendidikan :
									</p>
									<ul class="about-us-list">
										<li class="points">SD Negeri 22 Banda Aceh (2006-2012)</li>
										<li class="points">SMP Negeri 3 Banda Aceh (2012-2015)</li>
										<li class="points">SMK Negeri 5 Telkom Banda Aceh (2015-2018)</li>
							...
							<p>
										 Selama mengenyam dunia pendidikan, Alhamdulillah saya sudah menguasai beberapa keahlian dalam mengembangkan potensi dan minat bakat saya.
									</p><br/><br/>
							        <div class="barWrapper">
									 <span class="progressText"><B>Java</B></span>
									<div class="progress">
									...
									<div class="barWrapper">
									 <span class="progressText"><B>Dart</B></span>
									<div class="progress ">
									...
									<div class="barWrapper">
									 <span class="progressText"><B>Flutter</B></span>
									<div class="progress">
									...
									<div class="barWrapper">
										<span class="progressText"><B>Blender  3D</B></span>
									   <div class="progress">
									   ...
									   <div class="barWrapper">
										<span class="progressText"><B>Unity</B></span>
									   <div class="progress">
									...
									<div class="barWrapper">
									 <span class="progressText"><B>Adobe Ilustrator</B></span>
									<div class="progress">
									  <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
											 <span  class="popOver" data-toggle="tooltip" data-placement="top" title="85%"> </span>  
									  </div>
...
<section  id="service">
  <div class="container">
    <h2>Skills</h2>
	<h6>Skill yang ada di dalam diri aing</h6>
    <div class="service_wrapper">
      <div class="row">
        ...
        <div class="col-md-3"> 
		<div class="service_icon icon2  delay-03s animated wow zoomIn"> <span><i class="fa fa-joomla"></i></span> </div> 
		<div class="service_block">
            <h3 class="animated fadeInUp wow">3D Modelling</h3>
          </div>
        </div>
        <div class="col-md-3">
		<div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-html5"></i></span> </div>
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">Graphics Design</h3>
          </div>
        </div>
		  <div class="col-md-3">
...
<section id="Portfolio" class="content"> 
  ...
  <div class="container portfolio_title"> 
    ...
    <div class="section-title">
      <h2>Projects</h2>
	<h6>Alhamdulillah, Ini adalah beberapa project yang sudah pernah dikerjakan</h6>
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope fadeInLeft animated wow grid" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">  
         ...
         <figcaption>		
				<div>
				  <a href="img/portfolio_pic4.jpg" class="fancybox"> 
					<h2>Piala  <span>Presiden</span></h2> 
				  </a>
				</div>
			</figcaption>
      </figure>
	  ...
	  <!-- Portfolio Item-->
      <figure style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  android  prototype web isotope-item effect-oscar">
        <div class="portfolio_img"> <img src="img/portfolio_pic5.png" alt="Portfolio 1"> </div>
         <figcaption>		
				<div>
				  <a href="img/portfolio_pic5.png" class="fancybox"> 
					<h2>PMWL   <span></span></h2> 
				  </a>
				</div>
			</figcaption>
      </figure>
...
<section class="page_section team" id="team"><!--main-section team-start-->
  <div class="container">
    <h2>Our Team</h2>
    <h6>Inilah teman seperjuangan dalam mengerjakan suatu project</h6>
...
<footer class="footer_wrapper" id="contact">
  <div class="container">
    <section class="page_section contact" id="contact">
      <div class="contact_section">
        <h2>Get In Touch</h2>
	<h6>Yang mau nanya-nanya, boleh kok ...</h6>
      ...
      <div class="row">
        <div class="col-lg-4 wow fadeInLeft">	
		 <div class="contact_info">
                            <div class="detail">
                                <h4>Galang Pandu Pratama</h4>
                                <p>Pasheu Beutong, Aceh Besar, Aceh, Indonesia</p>
                            </div>
                            <div class="detail">
                                <h4>call us</h4>
                                <p>+62 822 8113 9627</p>
                            </div>
                            <div class="detail">
                                <h4>Email us</h4>
          ...
          <ul class="social_links">
            <li class="twitter animated bounceIn wow delay-02s"><a href="https://wa.link/n2uxnx"><i class="fa fa-comments"></i></a></li>
            <li class="facebook animated bounceIn wow delay-03s"><a href="https://www.instagram.com/galangpratamaaaa/"><i class="fa fa-instagram"></i></a></li>
            <li class="pinterest animated bounceIn wow delay-04s"><a href="https://www.youtube.com/channel/UC1va19-zmtI48zn0Wcx1FcQ"><i class="fa fa-youtube"></i></a></li>
            <li class="gplus animated bounceIn wow delay-05s"><a href="https://github.com/rapYOURex"><i class="fa fa-github"></i></a></li> 
          </ul>
        </div>
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © 2021. <a href="https://webthemez.com/free-bootstrap-templates/" target="_blank">Made with Love</a> By Monochrome</span> </div>
  </div>
</footer>
